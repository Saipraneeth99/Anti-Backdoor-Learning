...
def train_step(
    ...
    for batch_idx, (inputs1, targets1), (inputs2, targets2) in zip(range(len(train_dl1)), train_dl1, train_dl2):
        ...
        print("inputs_bd = ", (inputs_bd[0])
        inputs_bd.save('/content/drive/MyDrive/NetworkProject/input-aware-backdoor-attack-release/Images/Inputs' + batch_idx + ".png")
        patterns1.save('/content/drive/MyDrive/NetworkProject/input-aware-backdoor-attack-release/Images/Patterns' + batch_idx + ".png")
        masks1.save('/content/drive/MyDrive/NetworkProject/input-aware-backdoor-attack-release/Images/Masks' + batch_idx + ".png")
        print("saved images")
