...
def get_arguments():
    ...
    google_drive_path = '/content/drive/MyDrive/NetworkProject/ABL-main/'
    # various path
    parser.add_argument('--isolation_model_root', type=str, default=google_drive_path+'weight/ABL_results',
                        help='isolation model weights are saved here')
    parser.add_argument('--unlearning_root', type=str, default=google_drive_path+'weight/unlearn_model',
                        help='unlearning models weight are saved here')
    parser.add_argument('--checkpoint_root', type=str, default=google_drive_path+'weight/isolation_model/WRN-16-1SIG-tuning_epochs5.tar',
                        help='isolation models weight are saved here')
    parser.add_argument('--log_root', type=str, default=google_drive_path+'logs', help='logs are saved here')
    parser.add_argument('--dataset', type=str, default='CIFAR10', help='name of image dataset')
    parser.add_argument('--model_name', type=str, default='WRN-16-1', help='name of model')
    parser.add_argument('--isolate_data_root', type=str, default=google_drive_path+'isolation_data',
                        help='path of isolated data')
    parser.add_argument('--isolate_model_root', type=str, default=google_drive_path+'weight/isolation_model',
                        help='path of isolated model weights')
    parser.add_argument('--load_fixed_data', type=int, default=0, help='load the local poisoned dataest')
    parser.add_argument('--poisoned_data_path', type=str, default="", help='path to poisoned dataset')
